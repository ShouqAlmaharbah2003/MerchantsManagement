...
//        public MerchantsController(IMerchantsService service, IStringLocalizer<MerchantsController> localizer, ILogger<MerchantsController> logger) : base(localizer)
//        {
//            _service = service;
...
//            {
//                await _service.CreateMerchantAsync(dto).ConfigureAwait(false);
//                return SuccessResponse(_localizer["Merchantcreatedsuccessfully"]);// _localizer["Merchant created successfully."]
//            }
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["ErrorcreatingmerchantwithName_Ar: {Name_Ar},Name_En: {Name_En}"], dto.Name_Ar, dto.Name_En);// _localizer["Error creating merchant with Name_Ar: {Name_Ar}, Name_En: {Name_En}"]
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorfetchingactivemerchants"]);// _localizer["Error fetching active merchants"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorfetchingmerchantsbygroupid: {GroupId}"], groupId);// _localizer["Error fetching merchants by group id: {GroupId}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorfetchingmerchantdetailsforid: {Id}"], id);// _localizer["Error fetching merchant details for id: {Id}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorfetchingmerchantwithbranchesforid: {Id}"], id);// _localizer["Error fetching merchant with branches for id: {Id}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorfetchingmainbranchformerchantid: {MerchantId}"], merchantId);// _localizer["Error fetching main branch for merchant id: {MerchantId}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorsearchingmerchantswithparameters: {Name}, {Mobile}, {CityId}, {BranchName}"], name, mobile, cityId, branchName);// _localizer["Error searching merchants with parameters: {Name}, {Mobile}, {CityId}, {BranchName}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["ErrorgeneratingPDFforsearchwithparameters: {Name}, {Mobile}, {CityId}, {BranchName}"], name, mobile, cityId, branchName);// _localizer["Error generating PDF for search with parameters: {Name}, {Mobile}, {CityId}, {BranchName}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["ErrorgeneratingPDFwithbranchesforsearchwithparameters: {Name}, {Mobile}, {CityId}, {BranchName}"], name, mobile, cityId, branchName);// _localizer["Error generating PDF with branches for search with parameters: {Name}, {Mobile}, {CityId}, {BranchName}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            {
//                await _service.ChangeMerchantGroupIdAsync(merchantId, newGroupId).ConfigureAwait(false);
//                return SuccessResponse(_localizer["Merchantgroupchangedsuccessfully"]);// _localizer["Merchant group changed successfully."]
//            }
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorchangingmerchantgroupformerchantid: {MerchantId}"], merchantId);// _localizer["Error changing merchant group for merchant id: {MerchantId}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
...
//            {
//                await _service.UpdateMerchantDetailsAsync(merchantId, dto).ConfigureAwait(false);
//                return SuccessResponse(_localizer["Merchantupdatedsuccessfully"]);// _localizer["Merchant updated successfully."]
//            }
//            catch (Exception ex)
//            {
//                Log.Error(ex, _localizer["Errorupdatingmerchantdetailsformerchantid: {MerchantId}"], merchantId);// _localizer["Error updating merchant details for merchant id: {MerchantId}"]
//                return StatusCode(500, ErrorResponse(CommonLib.Enums.ErrorCodes.InternalServerError));
//            }
//        }
//    }
